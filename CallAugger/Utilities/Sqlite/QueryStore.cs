...
namespace CallAugger.Utilities.Sqlite
{
    internal class QueryStore
    {
        ...
        public static string CreatePharmaciesTable =
            "CREATE TABLE IF NOT EXISTS Pharmacies (id INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT, Npi TEXT, Dea Text, Ncpdp TEXT, Address TEXT, City TEXT, State TEXT, Zip TEXT, ContactName1 TEXT, ContactName2 TEXT, PrimaryPhoneNumber TEXT)";
        ...
        public static string InsertPharmacy =
            "INSERT INTO Pharmacies (Name, Npi, Dea, Ncpdp, Address, City, State, Zip, ContactName1, ContactName2, PrimaryPhoneNumber) VALUES (@Name, @Npi, @Dea, @Ncpdp, @Address, @City, @State, @Zip, @ContactName1, @ContactName2, @PrimaryPhoneNumber)";
